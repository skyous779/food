...
def main():
    ...
    config_ck = CheckpointConfig(save_checkpoint_steps=10*data.train_dataset.get_dataset_size(),
...
## python train.py --run_openi True --data_url /home/ma-user/work/data --batch_size 64  --num_classes 10 --pretrained True  --epochs 300 --fold_train 1 --fold 2