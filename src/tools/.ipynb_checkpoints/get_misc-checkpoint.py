...
def pretrained(args, model):
    ...
    if args.run_modelarts:
        ...
        if eval == 0:
            args.ckpt_url = '/home/ma-user/work/best.ckpt'
        else:
            args.ckpt_url= '/home/ma-user/work/food_conformer/ckpt_0/fold0_best.ckpt'
        print("=> loading pretrained weights from '{}'".format(args.ckpt_url))
        
        param_dict = load_checkpoint(args.ckpt_url) #预训练模型
